...
export function WorkSection() {
  return (
    <section
      id="projects"
      className="w-full max-w-6xl mx-auto px-4 md:px-8 lg:pl-16 relative z-10 min-h-screen disable-scrollbars py-16"
    >
      <div className="mb-12">
        <h2 className="text-3xl md:text-5xl font-bold font-mono tracking-tight text-white text-center md:text-left">
          Selected <span className="text-[#A1A1AA]">Projects</span>
        </h2>
